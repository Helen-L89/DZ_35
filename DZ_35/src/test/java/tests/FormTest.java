...
public class FormTest {
    ...
    private static final Logger logger = LoggerSetup.setupLogger(FormTest.class);
    ...
    void setUp() {
        ...
        logger.info("Initializing WebDriver...");
                WebDriver driver = WebDriverFactory.createDriver(BrowserType.fromString(browser));
